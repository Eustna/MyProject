...
watch_video_box=[126,587,258,611]
watch_video_bt=[249,599]
youtube_box=[127,1032,214,1061]
youtube_bt=[459,632]
end_box=[97,106,803,173]
x_bt=[572,27]
skip_video_bt=[852,131]
ten_box=[32,119,71,153]
error_box=[310,443,629,836]
check_box=[332,686,598,735]
img=[340+20,468,582+20,666]
cut1=[412+20,740,444+20,772]
cut2=[444+20,740,476+20,772]
cut3=[476+20,740,508+20,772]
        ...
        if "has been counted" in text:
            ...
            if True:
                ...
                if "10" in text:#检测卡视频
                    print("视频卡住，点击跳过")
                    time.sleep(0.5)
                    pyautogui.click(skip_video_bt[0],skip_video_bt[1])
                    break
                elif round_time == 20:
                    print("视频卡住，点击跳过")
                    time.sleep(0.5)
