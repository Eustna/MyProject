...
class getData(Dataset):
    def __init__(self):
        super().__init__()
        self.data = []
        path = r'E:\work\python_code\cydianx\labels'
        for i in os.listdir(path):
            self.data.append(['E:/work/python_code/cydianx/images/'+i.split('.')[0]+'.png', path+'/'+i])
...
for i in range(100):
    ...
    if sx/csl < maxLoss:
        torch.save( mymodo, r'E:\work\python_code\cydianx\mox2.pth')
        print("保存模型===》")
        maxLoss =sx/csl
