...
try:
    mymodo = torch.load(r'E:\work\python_code\cydianx\mox2.pth', map_location=device)
    mymodo.to(device)
    mymodo.eval()
    ...
    torch.onnx.export(mymodo, x, r'E:\work\python_code\cydianx\sbkuan.onnx', input_names=input_names, output_names=output_names, verbose='True')
    print("成功把画框模型转onnx")
except:
    pass
